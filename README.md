```
  _____                                ___           _       _
 |_   _|_ _ _ __   __ _ _   _ _   _  / _ \ _ __ ___(_)_ __ (_)
   | |/ _` | '_ \ / _` | | | | | | || | | | '__/ __| | '_ \| |
   | | (_| | | | | (_| | |_| | |_| || |_| | |  \__ \ | | | | |
   |_|\__,_|_| |_|\__, |\__,_|\__, | \___/|_|  |___/_|_| |_|_|
                   |___/       |___/
```
...
class AgenticEngineer:
    ...
    def stack(self):
        return {
            "agents":       ["Claude Agent SDK", "LangGraph", "CrewAI", "AutoGen"],
            "mcp":          ["Custom MCP Servers", "Tool Chains", "Protocol Design"],
            "ai_models":    ["Claude", "GPT-4o", "Gemini", "Local LLMs"],
...
|---------|-------------|-------|
| [**Open Paw**](https://github.com/tanguyors/open-paw) | Native desktop AI agent with multi-model router & floating pill overlay | `Rust` `Tauri v2` `Next.js` `MCP` |
| [**MCP Store**](https://github.com/tanguyors/mcp-store) | Marketplace for MCP servers — discover, install, and manage agent tools | `Next.js` `TypeScript` `Supabase` |
| [**ClaudeMD Generator**](https://github.com/tanguyors/claudemd-generator) | Generate perfect CLAUDE.md files from a guided questionnaire | `Next.js` `TypeScript` `GPT-4o` |
...
```
 ...
 │  ◆ MCP servers & tool chains for agent ecosystems           │
 │  ◆ Intelligent CRM systems with AI-driven pipelines         │
 │  ◆ Multi-model orchestration (Claude, GPT, Gemini, local)   │
 │  ◆ RAG architectures & knowledge base automation            │
 │  ◆ Production-grade automation replacing manual workflows    │
...
<img src="https://github-readme-stats.vercel.app/api?username=tanguyors&show_icons=true&theme=chartreuse-dark&hide_border=true&bg_color=0d1117&title_color=00ff00&icon_color=00ff00&text_color=c9d1d9" width="49%" />
<img src="https://github-readme-streak-stats.herokuapp.com/?user=tanguyors&theme=chartreuse-dark&hide_border=true&background=0d1117&ring=00ff00&fire=00ff00&currStreakLabel=00ff00" width="49%" />
...
```
 The future isn't about using AI tools.
